...
<body data-spy="scroll" data-target=".navbar" data-offset="60">
  ...
  <%if(session.getAttribute("userid") == null){ %>
    <div class="row">
      <div class="col-md-6 text-center">
        ...
        <form action="/login" method="POST">
          <div class="form-group">
            <input class="form-control" type="text" name="email" placeholder="Login Email" required />
          </div>
          <div class="form-group">
      ...
      <div class="col-md-6 text-center">
        <h3>CREATE A NEW ACCOUNT INSTANTLY</h3><br />
        <form action="/register" method="post">
          ...
          <div class="form-group">
            <input class="form-control" type="text" name="aadharproof" id="aadharproof" placeholder="Aadhar ID" required />
          </div>
          <div class="form-group">
            <input class="form-control" type="number" name="pin" id="pin" placeholder="PIN" required />
          </div>
          <div class="form-group">
    ...
    <%}else{ %>
    	<div>
    		<h1>Transfer Funds, Withdraw Funds, Receive Funds, Check Balance from comfort of your home</h1>
    	</div>
    <%} %>
  </div>
