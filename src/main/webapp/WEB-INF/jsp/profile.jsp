...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
					...
					<li class="active"><a href="/profile?id=<%=session.getAttribute("userid")%>" >PROFILE</a></li>
    ...
    <div class="text-center">
        <button class="btn btn-primary" style="width: 30%;">EDIT PROFILE</button>
        <button class="btn btn-primary" style="width: 30%;">CHANGE PASSWORD</button>
        <button class="btn btn-primary" style="width: 30%;">CHANGE PIN</button>
    </div>
        ...
        <div class="row gutters-sm  text-center">
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <h3 class="mb-0"><b>ID PROOF</b></h3>
                        </div>
                        <div class="col-sm-9">
                            <h3> <%=u.getAadharproof() %></h3>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-sm-3">
                            <h3 class="mb-0"><b>IFSC</b></h3>
                        </div>
                        <div class="col-sm-9">
                            <h3> <%=u.getAccount().getIfsc() %> </h3>
                        </div>
                    </div>
                    <hr>
                </div>
